...
if ( ! function_exists( 'ot_display_by_type' ) ) {
  ...
  function ot_display_by_type( $args = array() ) {
    ...
    if ( function_exists( $function_name_by_type ) ) {
      ...
      echo '<p>' . __( 'Sorry, this function does not exist', 'amory' ) . '</p>';
    }
      ...
      echo '<div class="format-setting-inner">'; 
        ...
        echo '<div class="ot-background-group">';
          ...
          if ( in_array( 'background-repeat', $ot_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-repeat]" id="' . esc_attr( $field_id ) . '-repeat" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . __( 'background-repeat', 'amory' ) . '</option>';
          ...
          if ( in_array( 'background-attachment', $ot_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-attachment]" id="' . esc_attr( $field_id ) . '-attachment" class="option-tree-ui-select ' . $field_class . '">';
              ...
              echo '<option value="">' . __( 'background-attachment', 'amory' ) . '</option>';
          ...
          if ( in_array( 'background-position', $ot_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-position]" id="' . esc_attr( $field_id ) . '-position" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . __( 'background-position', 'amory' ) . '</option>';
          ...
          if ( in_array( 'background-size', $ot_recognized_background_fields ) ) {
            ...
            if ( is_array( $choices ) && ! empty( $choices ) ) {
              ...
              echo '<input type="text" name="' . esc_attr( $field_name ) . '[background-size]" id="' . esc_attr( $field_id ) . '-size" value="' . ( isset( $field_value['background-size'] ) ? esc_attr( $field_value['background-size'] ) : '' ) . '" class="widefat ot-background-size-input option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'background-size', 'amory' ) . '" />';
        ...
        if ( in_array( 'background-image', $ot_recognized_background_fields ) ) {
          ...
          echo '<div class="option-tree-ui-upload-parent">';
            ...
            /* input */
            echo '<input type="text" name="' . esc_attr( $field_name ) . '[background-image]" id="' . esc_attr( $field_id ) . '" value="' . ( isset( $field_value['background-image'] ) ? esc_attr( $field_value['background-image'] ) : '' ) . '" class="widefat option-tree-ui-upload-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'background-image', 'amory' ) . '" />';
            
            /* add media button */
            echo '<a href="javascript:void(0);" class="ot_upload_media option-tree-ui-button button button-primary light" rel="' . $post_id . '" title="' . __( 'Add Media', 'amory' ) . '"><span class="icon ot-icon-plus-circle"></span>' . __( 'Add Media', 'amory' ) . '</a>';
          ...
          if ( isset( $field_value['background-image'] ) && $field_value['background-image'] !== '' ) {
            ...
            echo '<div class="option-tree-ui-media-wrap" id="' . esc_attr( $field_id ) . '_media">';
              ...
              echo '<a href="javascript:(void);" class="option-tree-ui-remove-media option-tree-ui-button button button-secondary light" title="' . __( 'Remove Media', 'amory' ) . '"><span class="icon ot-icon-minus-circle"></span>' . __( 'Remove Media', 'amory' ) . '</a>';
    ...
    echo '<div class="format-setting type-border ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( in_array( 'width', $ot_recognized_border_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-sixth"><input type="text" name="' . esc_attr( $field_name ) . '[width]" id="' . esc_attr( $field_id ) . '-width" value="' . esc_attr( $width ) . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'width', 'amory' ) . '" /></div>';
        ...
        if ( in_array( 'unit', $ot_recognized_border_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-fourth">';
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[unit]" id="' . esc_attr( $field_id ) . '-unit" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . __( 'unit', 'amory' ) . '</option>';
        ...
        if ( in_array( 'style', $ot_recognized_border_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-fourth">';
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[style]" id="' . esc_attr( $field_id ) . '-style" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . __( 'style', 'amory' ) . '</option>';
    ...
    echo '<div class="format-setting type-box-shadow ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( in_array( 'offset-x', $ot_recognized_box_shadow_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-fifth"><span class="ot-icon-arrows-h ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[offset-x]" id="' . esc_attr( $field_id ) . '-offset-x" value="' . $offset_x . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'offset-x', 'amory' ) . '" /></div>';
        ...
        if ( in_array( 'offset-y', $ot_recognized_box_shadow_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-fifth"><span class="ot-icon-arrows-v ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[offset-y]" id="' . esc_attr( $field_id ) . '-offset-y" value="' . $offset_y . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'offset-y', 'amory' ) . '" /></div>';
    ...
    echo '<div class="format-setting type-category-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( ! empty( $categories ) ) {
          ...
          echo '<p>' . __( 'No Categories Found', 'amory' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-custom-post-type-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
          ...
          echo '<p>' . __( 'No Posts Found', 'amory' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-custom-post-type-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
          ...
          echo '<option value="">' . __( 'No Posts Found', 'amory' ) . '</option>';
        }
    ...
    echo '<div class="format-setting type-dimension ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( in_array( 'width', $ot_recognized_dimension_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-third"><span class="ot-icon-arrows-h ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[width]" id="' . esc_attr( $field_id ) . '-width" value="' . esc_attr( $width ) . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'width', 'amory' ) . '" /></div>';
        ...
        if ( in_array( 'height', $ot_recognized_dimension_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-third"><span class="ot-icon-arrows-v ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[height]" id="' . esc_attr( $field_id ) . '-height" value="' . esc_attr( $height ) . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'height', 'amory' ) . '" /></div>';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( ! empty( $ids ) ) {
          ...
          <div class="ot-gallery-buttons">
            <a href="#" class="option-tree-ui-button button button-secondary hug-left ot-gallery-delete">' . __( 'Delete Gallery', 'amory' ) . '</a>
            <a href="#" class="option-tree-ui-button button button-primary right hug-right ot-gallery-edit">' . __( 'Edit Gallery', 'amory' ) . '</a>
          </div>';
          ...
          echo '
          <div class="ot-gallery-buttons">
            <a href="#" class="option-tree-ui-button button button-primary right hug-right ot-gallery-edit">' . __( 'Create Gallery', 'amory' ) . '</a>
          </div>';
  ...
  function ot_type_google_fonts( $args = array() ) {
    ...
    echo '<div class="format-setting type-google-font ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">'; 
		...
		if(!empty( $value['family'] )){
          echo '<div class="type-google-font-group">';
            ...
            echo '<div class="option-tree-google-font-family">';
              echo '<a href="javascript:void(0);" class="js-remove-google-font option-tree-ui-button button button-secondary light" title="' . __( 'Remove Google Font', 'amory' ) . '"><span class="icon ot-icon-minus-circle"/>' . __( 'Remove Google Font', 'amory' ) . '</a>';
        ...
        echo '<a href="javascript:void(0);" class="js-add-google-font option-tree-ui-button button button-primary right hug-right" title="' . __( 'Add Google Font', 'amory' ) . '">' . __( 'Add Google Font', 'amory' ) . '</a>';
    ...
    echo '<div class="format-setting type-link-color ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        $ot_recognized_link_color_fields = apply_filters( 'ot_recognized_link_color_fields', array(
          'link'    => _x( 'Standard', 'color picker', 'amory' ),
          'hover'   => _x( 'Hover', 'color picker', 'amory' ),
          'active'  => _x( 'Active', 'color picker', 'amory' ),
          'visited' => _x( 'Visited', 'color picker', 'amory' ),
          'focus'   => _x( 'Focus', 'color picker', 'amory' )
        ), $field_id );
  ...
  function ot_type_list_item( $args = array() ) {
    ...
    echo '<div class="format-setting type-list-item ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* button */
        echo '<a href="javascript:void(0);" class="option-tree-list-item-add option-tree-ui-button button button-primary right hug-right" title="' . __( 'Add New', 'amory' ) . '">' . __( 'Add New', 'amory' ) . '</a>';
        
        /* description */
        $list_desc = $sortable ? __( 'You can re-order with drag & drop, the order will update after saving.', 'amory' ) : '';
      ...
      echo '<div class="format-setting-inner">';
        ...
        $field_choices = array(
          array(
             ...
             */
            'label'   => apply_filters( 'ot_on_off_switch_on_label', __( 'On', 'amory' ), $field_id, '1' )
          ),
          array(
            /**
             ...
             * @param string $filter_id For filtering both on/off label with one function.
             */
            'label'   => apply_filters( 'ot_on_off_switch_off_label', __( 'Off', 'amory' ), $field_id, '' )
          )
        );
  ...
  function ot_type_page_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-page-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
        ...
        echo '<p>' . __( 'No Pages Found', 'amory' ) . '</p>';
      }
    ...
    echo '<div class="format-setting type-page-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
          ...
          echo '<option value="">' . __( 'No Pages Found', 'amory' ) . '</option>';
        }
  ...
  function ot_type_sidebar_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-sidebar-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* has sidebars */
        if ( count( $sidebars ) ) {
          echo '<option value="">-- ' . __( 'Choose Sidebar', 'amory' ) . ' --</option>';
          foreach ( $sidebars as $id => $sidebar ) {
            echo '<option value="' . esc_attr( $id ) . '"' . selected( $field_value, $id, false ) . '>' . esc_attr( $sidebar ) . '</option>';
          }
        } else {
          echo '<option value="">' . __( 'No Sidebars', 'amory' ) . '</option>';
        }
  ...
  function ot_type_slider( $args = array() ) {
    ...
    echo '<div class="format-setting type-slider ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* description */
        echo '<div class="list-item-description">' . __( 'You can re-order with drag & drop, the order will update after saving.', 'amory' ) . '</div>';
  ...
  function ot_type_social_links( $args = array() ) {
    ...
    if ( empty( $field_value ) && apply_filters( 'ot_type_social_links_load_defaults', true, $field_id ) ) {
      ...
      $field_value = apply_filters( 'ot_type_social_links_defaults', array(
        array(
          'name'    => __( 'Facebook', 'amory' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Twitter', 'amory' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Google+', 'amory' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'LinkedIn', 'amory' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Pinterest', 'amory' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Youtube', 'amory' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Dribbble', 'amory' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Github', 'amory' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Forrst', 'amory' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
        ...
        array(
          'name'    => __( 'Delicious', 'amory' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'Tumblr', 'amory' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
        ...
        array(
          'name'    => __( 'Flickr', 'amory' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => __( 'VK.com', 'amory' ),
          'title'   => '',
          'href'    => ''
        )
      ), $field_id );
    ...
    echo '<div class="format-setting type-social-list-item ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* button */
        echo '<a href="javascript:void(0);" class="option-tree-social-links-add option-tree-ui-button button button-primary right hug-right" title="' . __( 'Add New', 'amory' ) . '">' . __( 'Add New', 'amory' ) . '</a>';
        
        /* description */
        echo '<div class="list-item-description">' . apply_filters( 'ot_social_links_description', __( 'You can re-order with drag & drop, the order will update after saving.', 'amory' ), $field_id ) . '</div>';
    ...
    echo '<div class="format-setting type-spacing ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( in_array( 'top', $ot_recognized_spacing_fields ) ) {
          ...
          echo '<div class="ot-option-group"><span class="ot-icon-arrow-up ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[top]" id="' . esc_attr( $field_id ) . '-top" value="' . $top . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'top', 'amory' ) . '" /></div>';
        ...
        if ( in_array( 'right', $ot_recognized_spacing_fields ) ) {
          ...
          echo '<div class="ot-option-group"><span class="ot-icon-arrow-right ot-option-group--icon"></span></span><input type="text" name="' . esc_attr( $field_name ) . '[right]" id="' . esc_attr( $field_id ) . '-right" value="' . $right . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'right', 'amory' ) . '" /></div>';
        ...
        if ( in_array( 'bottom', $ot_recognized_spacing_fields ) ) {
          ...
          echo '<div class="ot-option-group"><span class="ot-icon-arrow-down ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[bottom]" id="' . esc_attr( $field_id ) . '-bottom" value="' . $bottom . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'bottom', 'amory' ) . '" /></div>';
        ...
        if ( in_array( 'left', $ot_recognized_spacing_fields ) ) {
          ...
          echo '<div class="ot-option-group"><span class="ot-icon-arrow-left ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[left]" id="' . esc_attr( $field_id ) . '-left" value="' . $left . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'left', 'amory' ) . '" /></div>';
    ...
    echo '<div class="format-setting type-tag-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $tags ) {
          ...
          echo '<p>' . __( 'No Tags Found', 'amory' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-tag-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $tags ) {
          ...
          echo '<option value="">' . __( 'No Tags Found', 'amory' ) . '</option>';
        }
    ...
    echo '<div class="format-setting type-taxonomy-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $taxonomies ) {
          ...
          echo '<p>' . __( 'No Taxonomies Found', 'amory' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-tag-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $taxonomies ) {
          ...
          echo '<option value="">' . __( 'No Taxonomies Found', 'amory' ) . '</option>';
        }
...
if ( ! function_exists( 'ot_type_import' ) ) {
  ...
  function ot_type_import( $args = array() ) {
	...
	if(isset($_GET["pmc_import"]) && $_GET["pmc_import"] == 'true'){ 
		echo '<div class="import-true">'. $import = esc_html__('Import was successful! Enjoy the theme.','amory').'</div>';
	}
	if(isset($_GET["pmc_import"]) && $_GET["pmc_import"] == 'false'){ 
		echo '<div class="import-true">'. $import = esc_html__('Importing...','amory').'</div>';
	}	
      ...
      ?>
		...
		<p><input type="radio" name="import_demo" value="default" checked>Default Theme -> <a target = "_blank" href="http://amory.premiumcoding.com">Check demo</a></p>
		<p><input type="radio" name="import_demo" value="boxed" >Boxed Theme-> <a target = "_blank" href="http://amory.premiumcoding.com/boxed">Check demo</a></p>
		<p><input type="radio" name="import_demo" value="minimal" >Minimal Theme-> <a target = "_blank" href="http://amory.premiumcoding.com/minimal">Check demo</a></p>		
		<p><input type="radio" name="import_demo" value="dark" >Dark Theme-> <a target = "_blank" href="http://amory.premiumcoding.com/manly">Check demo</a></p>
		<p><input type="radio" name="import_demo" value="fullwidth" >Full Width Theme-> <a target = "_blank" href="http://amory.premiumcoding.com/fullwidth">Check demo</a></p>		<p><input type="radio" name="import_demo" value="grid" >Grid Theme-> <a target = "_blank" href="http://amory.premiumcoding.com/grid">Check demo</a></p>		
		<p><input type="radio" name="import_demo" value="photo" >Photography Theme-> <a target = "_blank" href="http://amory.premiumcoding.com/photography">Check demo</a></p>		<p><input type="radio" name="import_demo" value="hipster" >Hipster Theme-> <a target = "_blank" href="http://amory.premiumcoding.com/demo3">Check demo</a></p>		
		<p><input type="radio" name="import_demo" value="magazine" >Magazine Theme-> <a target = "_blank" href="http://amory.premiumcoding.com/demo2">Check demo</a></p>	


		<input type="hidden" id = "pmc_import" value = "<?php echo admin_url( 'themes.php?page=ot-theme-options&pmc_import=start&import_demo=' ) ?>">	
    <?php 
	  echo '<button class="button-primary left import">' . esc_html__('Import', 'amory'). '</button>';	
      echo '</div>';
