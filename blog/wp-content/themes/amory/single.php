	...
	<div class="content singledefult">
		<div class="postcontent singledefult" id="post-<?php  get_the_id(); ?>" <?php post_class(); ?>>		
			<div class="blogpost">		
				<div class="posttext">
					<div class="topBlog">	
						...
						<div class = "post-meta">
							...
							$year= get_the_date('Y');
							?>
							<?php echo '<a class="post-meta-time" href="'.get_day_link( $year, $month, $day ).'">'; ?><?php echo get_the_date() ?></a><a class="post-meta-author" href="<?php echo  the_author_meta( 'user_url' ) ?>"><?php esc_html_e('por ','amory'); echo get_the_author(); ?></a><a href="#commentform"><?php comments_number(); ?></a><?php echo '<em>' . get_the_category_list( esc_html__( ', ', 'amory' ) ) . '</em>'; ?>
						</div>
						<?php } ?> 					
				...
				<div class="blog-info">
					...
					<div class="blog_social"> <?php esc_html_e('COMPARTILHE: ','amory') . amory_socialLinkSingle(get_the_permalink(),get_the_title())  ?></div>	
					<?php } ?>
		...
		<div class="relatedPosts">
			<div class="relatedtitle">
				<h4><?php  esc_html_e('RELACIONADOS','amory'); ?></h4>
			</div>
			<div class="related">	
		...
		<div class = "post-navigation">
			<?php next_post_link('%link', '<div class="link-title-previous"><span>&#171; '.esc_html__('Anterior','amory').'</span><div class="prev-post-title">%title</div></div>' ,false,''); ?> 
			<?php previous_post_link('%link','<div class="link-title-next"><span>'.esc_html__('Próximo','amory').' &#187;</span><div class="next-post-title">%title</div></div>',false,''); ?> 
		</div>
